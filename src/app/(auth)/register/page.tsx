    ...
    <div className="flex min-h-screen items-center justify-center bg-stone-50 px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <Link href="/" className="inline-flex items-center gap-2 text-2xl font-bold text-stone-900">
            <span>🤖</span>
            <span>オートマ退職</span>
          </Link>
          <p className="mt-2 text-stone-500">はじめに無料アカウントを作成します</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="rounded-xl bg-emerald-50 border border-emerald-200 p-3">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-emerald-800">
                  個人情報は厳重に管理します。メール・退職届は送信完了後に自動削除されます。
                </p>
              </div>
            </div>
            ...
            <p className="text-center text-sm text-stone-500">
              すでにアカウントをお持ちの方は
              <Link href="/login" className="text-emerald-600 hover:underline ml-1">ログイン</Link>
            </p>
          </CardContent>
        </Card>
      </div>
